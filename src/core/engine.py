...
from src.scenes.capture_scene import CaptureScene
...
class Engine:
    ...
    def __init__(self):
        ...
        scene_manager.register_scene("battle_scene", BattleScene())
        scene_manager.register_scene("capture_scene", CaptureScene())
        '''
        [TODO HACKATHON 5]
